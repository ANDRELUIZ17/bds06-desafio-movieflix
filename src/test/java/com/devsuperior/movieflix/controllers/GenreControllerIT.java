...
public class GenreControllerIT {
	...
	@Test
	public void LocalizarTudoDeveRetornarNaoAutorizadoQuandoNaoValidoToken() throws Exception {
	...
	@Test
	public void EncontrarTodosOsGenerosDeveRetornarOsGenerosQuandoOVisitanteAutenticado() throws Exception {
	...
	//encontrar todos os gêneros devem retornar todos os gêneros quando o membro autenticado
	@Test
	public void EncontrarTodosOsGenerosDevemRetornarTodosOsGenerosQuandoOMembroAutenticado() throws Exception {
