...
class ReviewResourceIT {
	...
	@Test
	void InserirDeveInserirRevisaoQuandoMembroAutenticadoEDadosValidos() throws Exception {
	...
	@Test
	void InserirDeveRetornarEntidadeNaoProcessavelQuandoMembroAutenticadoEDadosInvalidos() throws Exception {
